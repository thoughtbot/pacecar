...
To get all users that have a first_name set, who are admins and approved more than 2 weeks ago...

  User.first_name_present.admin.approved_at_before(2.weeks.ago)
