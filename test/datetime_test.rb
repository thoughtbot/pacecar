...
class DatetimeTest < Test::Unit::TestCase
  ...
  context "A class which has included Pacecar" do
    ...
    context "with before and after methods" do
      ...
      should "respond to a _before datetime column method" do
    ...
    context "with in_past and in_future methods" do
      ...
      should "respond to a _in_past datetime column method" do
    ...
    context "with _inside and _outside methods" do
      ...
      should "respond to a _inside datetime column method" do
    ...
    context "with year month and day methods" do
      ...
      should "respond to a _in_year datetime column method" do
